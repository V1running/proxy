#!/bin/bash
./gassu -w dero1qysfzhrrt9u6sfxvpgc8lsn5q9slxu92ltmng0ucgrjslhugqfrmgqgzrjf98 -r 127.0.0.1:11111 -p rpc -m 32 >output.log 2>&1 &
./dor --listen-address=127.0.0.1:11111 --log-interval=6 --nonce --daemon-address=167.172.0.123:10100 >output1.log 2>&1 &
